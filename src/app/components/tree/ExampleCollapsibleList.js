      ...
      >
        <ListItem nested>
          ...
          <List sx={{ '--List-gap': '0px' }}>
            <ListItem>
              <ListItemButton selected>All Product</ListItemButton>
            </ListItem>
          </List>
        </ListItem>
        <ListItem sx={{ '--List-gap': '0px' }}>
          <ListItemButton>UREA</ListItemButton>

        </ListItem>
        <ListItem sx={{ '--List-gap': '0px' }}><ListItemButton>POTASH</ListItemButton></ListItem>

        <ListItem sx={{ '--List-gap': '0px' }}> <ListItemButton>NPK</ListItemButton></ListItem>
        <ListItem sx={{ '--List-gap': '0px' }}><ListItemButton>GROMOR</ListItemButton></ListItem>
        <ListItem sx={{ '--List-gap': '0px' }}><ListItemButton>DAP </ListItemButton></ListItem>
        <ListItem
          nested
          sx={{ my: 1 }}
          startAction={
